...
public class TextSel2 {
     ...
     */
    public TextSel2(TextBlock aTextBlock, int aStart, int aEnd)
    {
     ...
     */
    public TextSel2(TextBlock aTextBlock, double x1, double y1, double x2, double y2, boolean isWordSel, boolean isParaSel)
    {
        // Get text
        _textBlock = aTextBlock;
    ...
    {
        return Math.min(_anchor, _textBlock.length());
    }
    ...
    public int getIndex()
    {
        return Math.min(_index, _textBlock.length());
    }
    ...
    public int getStart()
    {
        return Math.min(_start, _textBlock.length());
    }
    ...
    public int getEnd()
    {
        return Math.min(_end, _textBlock.length());
    }
    ...
    {
        return _textBlock.subSequence(getStart(), getEnd()).toString();
    }
