...
public class TextModel extends TextLayout {
    ...
    {
        if (aString.contentEquals(getChars())) return;
     ...
     */
    public static TextModel createDefaultTextModel()  { return new TextModel(); }

    /**
     * Creates a default text model with option for rich text.
     */
    public static TextModel createDefaultTextModel(boolean isRich)  { return new TextModel(isRich); }
}
