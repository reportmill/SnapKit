 ...
 * Returns the clipboard content.
 */
protected ClipboardData getDataImpl(String aMimeType)  { return _cdatas.get(aMimeType); }
 ...
 * Adds clipboard content.
 */
protected void addDataImpl(String aMimeType, ClipboardData theData)  { _cdatas.put(aMimeType, theData); }
...
public boolean hasImage()
{
    ...
    for(String type : types) if(hasData(type))
        return true;
    return false;
}
 ...
 */
public static Clipboard getCleared()  { Clipboard cb = get(); cb.clearData(); return cb; }
