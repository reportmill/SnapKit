...
public class SoundRecorder {
        ...
        _recordThread = new Thread() {
            public void run()
            {
                try {
                    ...
                    System.err.println("SoundRecorder.recordStart:" + e);
                }
            }
        };
        _recordThread.start();
    ...
    private void startRecordingImpl() throws LineUnavailableException
    {
        ...
        try {
            ...
            System.err.println("SoundData.record" + e);
        }
        ...
        try {
            ...
            System.err.println("SoundData.recordStartImpl: AudioSystem.write failed: " + e);
        }
        ...
        _sndFile = FileUtils.getTempFile("SoundRec_Last.wav");
        _sndFile.deleteOnExit();
        try {
            FileUtils.writeBytes(_sndFile, bytes);
        } catch (Exception e) {
    ...
    public void stopRecording()
    {
        ...
        try {
            ...
            System.err.println("SoundRecorder.recordStop:" + e);
        }
        finally {
            _recordThread = null;
        }
