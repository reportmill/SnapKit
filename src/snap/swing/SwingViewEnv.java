...
public class SwingViewEnv extends ViewEnv {
    ...
    {
        return SwingClipboard.getDrag(null);
    }
    ...
    public void activateApp(View aView)
    {
        ...
        WindowView aWin = aView.getWindow();
        if (aWin.isFocused()) return;
