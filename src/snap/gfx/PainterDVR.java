...
public class PainterDVR extends PainterImpl {
    ...
    // The instructions
    List <Instruction>   _instrs = new ArrayList();
    
    // The Painter (for EffectPntr)
    Painter              _pntr;

/**
 * Creates a new PainterDVR.
 */
public PainterDVR()  { }
 ...
 */
public PainterDVR(Painter aPntr)  { _pntr = aPntr; }

/**
 * Executes the instructions stored in this PainterDVR to given painter.
 */
public void exec(Painter aPntr)  { for(Instruction i : _instrs) i.exec(aPntr); }
...
public Image getImage(Rect aRect, int anInset)
{
    ...
    int width = (int)Math.round(aRect.getWidth()) + anInset*2, height = (int)Math.round(aRect.getHeight()) + anInset*2;
    
    // Create new image for dvr painter and paint dvr to it
    Image img = Image.get(width, height, true);
    Painter ipntr = img.getPainter(); ipntr.setImageQuality(1);
...
/** Sets the font. */
public void setFont(Font aFont)  { super.setFont(aFont); add(new SetFont(aFont)); }

/** Sets the paint. */
public void setPaint(Paint aPaint)  { super.setPaint(aPaint); add(new SetPaint(aPaint)); }

/** Sets the stroke. */
public void setStroke(Stroke aStroke)  { super.setStroke(aStroke); add(new SetStroke(aStroke)); }

/** Sets the opacity. */
public void setOpacity(double aValue)  { super.setOpacity(aValue); add(new SetOpacity(aValue)); }

/** Stroke the given shape. */
public void draw(Shape aShape)  { super.draw(aShape); add(new DrawShape(aShape)); }

/** Fill the given shape. */
public void fill(Shape aShape)  { super.fill(aShape); add(new FillShape(aShape)); }
...
public void save()  { super.save(); add(new Save()); }
 ...
 * Adds an instruction.
 */
public void add(Instruction anInstr)  { _instrs.add(anInstr); }
