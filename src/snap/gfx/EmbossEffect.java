 ...
 */
public EmbossEffect(double anAlt, double anAzi, double aRad)  { _altitude = anAlt; _azimuth = anAzi; _radius = aRad; }
 ...
 */
public EmbossEffect copyForAltitude(double anAlt)  { return new EmbossEffect(anAlt, _azimuth, _radius); }

/**
 * Returns a new Emboss for given azimuth.
 */
public EmbossEffect copyForAzimuth(double anAzi)  { return new EmbossEffect(_altitude, anAzi, _radius); }

/**
 * Returns a new Emboss for given radius.
 */
public EmbossEffect copyForRadius(double aRad)  { return new EmbossEffect(_altitude, _azimuth, aRad); }
