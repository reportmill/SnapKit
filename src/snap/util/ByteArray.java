...
public class ByteArray implements Cloneable, Serializable {
     ...
     */
    public ByteArray(int aCapacity)
    {
        _bytes = new byte[aCapacity];
    }
    ...
    {
        return new ByteArrayInputStream(_bytes, 0, _length);
    }
     ...
     */
    public ByteArray append(int anInt)
    {
        int i = loadCharBuffer(anInt);
        return append(_charbuffer, i, 12 - i);
    }

    /**
     * Appends an object's string representation to the data.
     */
    public ByteArray append(Object o)
    {
     ...
     */
    public ByteArray append(String aString)
    {
        int i = loadCharBuffer(aString);
        return append(_charbuffer, 0, i);
    }
    ...
    {
        return append(data._bytes, 0, data._length);
    }
     ...
     */
    public void insert(int index, ByteArray data)
    {
        insert(index, data._bytes, 0, data._length);
    }
    ...
    private int loadCharBuffer(int anInt)
    {
        ...
        boolean negative = anInt < 0;
        if (negative) anInt = -anInt;
        int charPos = 12;
    ...
    public int hashCode()
    {
        return _bytes != null ? _bytes.hashCode() : 0;
    }
    ...
    public Object clone()
    {
        ByteArray clone = null;
        try {
            clone = (ByteArray) super.clone();
        } catch (Exception e) {
        } // Do normal clone
    ...
    {
        return toString(0, _length, "ISO-8859-1");
    }
    ...
    {
        try {
            return new String(_bytes, start, end - start, encoding);
        } catch (Exception e) {
            return new String(_bytes, start, end - start);
        }
    }
