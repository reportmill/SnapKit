...
{
    _list.add(anIndex, anItem); _array = null;
...
{
    E item = _list.remove(anIndex); _array = null;
 ...
 */
protected void firePropChange(PropChange anEvent)  { _pcs.firePropChange(anEvent); }
