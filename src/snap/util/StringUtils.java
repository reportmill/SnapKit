...
public class StringUtils {
     ...
     * Returns whether a char is a newline char.
     */
    public static final boolean isLineEndChar(char c)
    {
        return c == '\r' || c == '\n';
    }
    ...
    {
        return indexOfIC(theStrings, aString) >= 0;
    }
    ...
    {
        return getStringSurrounded(aString, "\"", "\\\"");
    }
